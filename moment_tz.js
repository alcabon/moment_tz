function moment_tz () {
  ...
  import_moment_timezone.default.tz.setDefault("America/New_York");
  window.moment = import_moment_timezone.default;
  console.log("Current time in New York:", (0, import_moment_timezone.default)().format());
}

(function (global) {
  global = global || self;
  global.moment_tz = moment_tz ();
})(this)();
